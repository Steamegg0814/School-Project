...
###connect sqlite##
conn = sqlite3.connect('/home/steamegg/文件/Sqlite/test.db')
print ("成功連接sqlite")
c = conn.cursor()


###connect mysql##
db = pymysql.connect(host="172.20.10.4",port=3306,user= "IoT",password= "0000", db="speedAlert",charset="utf8")
print ("成功連接mysql")
cursor = db.cursor()
...
##建立資料表######
c.execute('''CREATE TABLE speedAlert
       (time      TEXT    NOT NULL,
       speed      INT     NOT NULL);''')
print ("成功建立資料表")
conn.commit()
